...
int main(int argc, char** argv) {
    ...
    cout << "Calculating theirMatrix2 = myMatrix1 * yourMatrix2;\n";
	...
	//You said not to add anything but I added this so I could read what outputs on Visual Studio
	//cin.ignore(256, '\n');
	//cin.get();
